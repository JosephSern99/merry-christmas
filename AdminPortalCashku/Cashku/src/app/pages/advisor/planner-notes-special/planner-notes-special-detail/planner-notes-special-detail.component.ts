...
@Component({
    selector: 'app-planner-notes-special-detail',
    templateUrl: '../../../advisor/note/note-detail/note-detail.component.html',
    styleUrls: ['../../../advisor/note/note-detail/note-detail.component.scss', './planner-notes-special-detail.component.scss'],
    standalone: false
})
export class PlannerNotesSpecialDetailComponent extends NoteDetailComponent {
    ...
    getBreadcrumbs(): { path: string; title: string; }[] {
        return [
            ...
            { path: '', title: 'Planner Note Details' },
        ];
    }
